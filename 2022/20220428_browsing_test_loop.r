...
dataroot <- ("C:/iLand/2022/20220422_browsing_test/all_sw/")                        # Root for the selection of the data
...
cases <-c("brow0", "brow0.3","brow0.5","brow0.8","brow1")
...
print(values)
values_sum <- values %>%
  filter(run == "brow0", type=="finalcut", type == "thinning", type == "regcut")  # to have the results you have to decide only one type at time
