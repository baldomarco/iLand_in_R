...
dataroot<-"C:/iland_data_test/iLand_spinup_czechia_random/output/"

file1<-paste0(dataroot,"Cz_region_20220214_BAU_SW_management_all_stps_and_constrains_small_area.sqlite")            # with planting activity and clear cut 0.2
...
# IN SEQUENCE:
# UFE                id 3343  index 2775 STP3 piab
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"Cz_region_20220127_BAU_SW_management_all_stps_and_constrains_stm1.r"
