...
dataroot<-"C:/man_impl_test_16_12/output"

file1<-paste0(dataroot,"subregion_medium_tatra_bilek_stp3_stems_without_height_sw.sqlite")            # with planting activity and useSustainableHarvest 0.2
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"_16_12_stems_sw_200ys"
