...
dataroot<-"C:/iland_data_test/20220127/"

file1<-paste0(dataroot,"Cz_region_20220127_BAU_management_all_stps_and_constrains_stm1.sqlite")            # with planting activity and clear cut 0.2
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"Cz_region_20220127_BAU_management_all_stps_and_constrains_stm1.r"
