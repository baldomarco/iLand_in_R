...
for (i in (1:length(all_v)))  {                                       # We read in the files in the loop. The "i" is for the x-> 1:i 
  ...
  conifers <-c("pini", "pisy", "psme", "lade", "piab", "abal", "pisy")
...
write.csv(variables.all, "C:/iLand/2022/20220604_final_test/DB_final/variables.all_20220628.csv", row.names = FALSE)
