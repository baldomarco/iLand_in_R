...
file1<-paste0(dataroot,"Cz_region_test_20220112_BAU_management_without_stems_smallarea.sqlite")            # with planting activity and clear cut 0.2
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"2022_01_07_Cz_region_test_20220112_BAU_management_without_stems_smallarea_test1.r"
