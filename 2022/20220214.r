#                                                                        MARCO BALDO, 14/02/2022

## NEW SCRIPT FOR THE ANALYSIS ON THE SPINUP_AFTER_1500 IN THE CZ REGION OF KOSTELEC 
## HERE WE FIND THE TEST IN DIFFERENT STANDS AS REPORTED DOWN HERE

hi, I checked now these 3 "fasy" stands in the target file that tells to the spinup what species composition it wants to reach.... and they are not really high in fasy... stands:  28182, 28312, 1988

28182: abal40%, fasy 30%, tico 30%
28312: piab 80% fasy 14%
1988:  96% piab, fasy 3%, ...

## FROM MY SELECTION
Stand id 1850, stp1, piab, ru 7028
Stand id 28182, stp2, fasy, ru 7487
Stand id 1241, stp4, pisy, ru6167
Stand id 28312, stp3, fasy, ru7486
Stand id 28185, stp 2, quro, ru7849
Stand id 28186, stp3, lade, ru6621
Stand id 1988, stp3, fasy, ru7849

# FROM LAURA DOBOR SELECTION

I checked a few ones now in iLand for the north area
stand 3572  -  ru3137  (index value in the console)
stand 29435 - ru2710
stand 1850 - ru4257

first two has target as 100% beech, the last one 88%

## THE MANAGEMENT IS CLEARCUT AND SHALTERWOOD FOR THE SAME CASE STUDY 
...
dataroot<-"C:/iland_data_test/20220214/"

file1<-paste0(dataroot,"Cz_region_20220214_BAU_management_all_stps_and_constrains_small_area.sqlite")            # with planting activity and clear cut 0.2
...
#---------------- TO SEE THE INFORMATION ON THE STAND ID, STPS, SPECIES GO TO THE UPPER COMMENTS TO THE BEGINING
...
mystands<-c(3572,29435,1850,1850,28182,1241,28312,28185,28186,1988)
myrus<-c(3137,2710,4257,7028,7487,6167,7486,7849,6621,7849)
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"Cz_region_20220214_BAU_management_all_stps_and_constrains_small_area.r"
