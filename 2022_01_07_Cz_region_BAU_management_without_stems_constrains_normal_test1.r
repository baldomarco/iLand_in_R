...
mystands<-c(48689,46805,20606,48734)
myrus<-c(7168,757,3399,7096)
...
for (cases in 1:length(mystands)) {
  ...
  outputfilename<-"2022_01_07_Cz_region_BAU_management_without_stems_constrains_normal_test1.r"
